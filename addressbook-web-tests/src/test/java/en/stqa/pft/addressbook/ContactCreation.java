...
public class ContactCreation {
  ...
  public void tContactCreation() {
    gotoContactPage();
    fillinContactPage("name", "surname", "company", "address", "phone", "email");
    submitContact();
    logout();
  }
  ...
  private void fillinContactPage(String name, String surname, String company, String address, String phone, String email) {
